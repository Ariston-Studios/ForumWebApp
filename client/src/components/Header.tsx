...
function Header() {
  ...
  return (
    <nav className={`fixed z-10 top-0 left-0 right-0 shadow-lg ${location.pathname === "/feed" && "border-b-2 border-gray-500 "} bg-white dark:bg-gray-950 divide-solid divide-green-400 dark:text-white`}>
      <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Logo />
        <div className="hidden w-full md:flex md:w-1/3 mx-auto justify-center" id="navbar-default">
            <ul className="font-medium flex flex-col items-center border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse p-4 md:p-0 mt-4 md:mt-0 md:border-0 dark:border-gray-700">
            <div className="flex items-center p-1 border-3 rounded-full bg-gray-800 border-gray-300 dark:border-gray-600 focus-within:border-green-400 transition-all">
