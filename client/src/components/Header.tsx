    ...
    <nav className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-950 divide-solid divide-green-400 dark:text-white">
      <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:flex md:w-1/3 mx-auto justify-center" id="navbar-default">
            ...
            <div className="flex items-center p-1 border rounded-full bg-gray-700 border-gray-300 dark:border-gray-600 focus-within:border-green-400 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
                    <input className="p-1 w-15 focus:w-70 delay-20 transition-all focus:outline-none" type="text" placeholder="Search [FORUM]"/>
                </div>
            </ul>
        </div>
