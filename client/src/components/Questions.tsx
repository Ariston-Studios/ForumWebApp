                ...
                <div key={q.id} className="border-b pb-4 flex space-x-4 items-start">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-2">
                            ...
                            <button className="flex items-center text-gray-50 hover:text-gray-400" onClick={() => toggleComments(q.id)}>
                                <FaCommentDots className="mr-1" />
                                <span>Comment</span>
                            </button>

                            <button className="flex items-center text-gray-50 hover:text-gray-400">
                        ...
                        {openComments === q.id && (
                            <div className="mt-4 space-y-2">
                                ...
                                <div className="mt-2 flex ">
                                    <input type="text" placeholder="Write a comment..." className="w-full p-2 border border-e-0 rounded rounded-e-none " />
                                    <button onClick={handlePost} className="px-2 mr-1 py-2 border text-white rounded rounded-s-none cursor-pointer">Post</button>
                                </div>
                            </div>
                        )}
                    </div>
