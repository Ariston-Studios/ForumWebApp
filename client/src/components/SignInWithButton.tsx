function SignInWithButton(props: any) {
  ...
  return (
    <button onClick={handleLogin} className="w-70 h-15 mx-auto my-5 flex flex-col justify-center cursor-pointer outline-2 hover:outline-fuchsia-600 rounded-md">
